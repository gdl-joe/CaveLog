// Custom SVG-Icons im handgezeichneten Höhlen-Stil

export default function CLIcon({ name, size = 24, color = 'currentColor', strokeWidth = 1.6 }) {
  const p = {
  ...
  switch (name) {
    ...
    case 'location': return (
      <svg {...p}>
        ...
        <path d="M12 22c0 0-8-8-8-12a8 8 0 0116 0c0 4-8 12-8 12z"/>
      </svg>
    );
    default: return (
